...
const Reset = () => {
  ...
  <div className='flex-1 gap-2 sm:gap-4 text-xs sm:text-sm flex flex-col justify-center items-center'>
    ...
    <input type="text" onChange={(e) => {setError(null); setEmail(e.target.value)}} value={email} placeholder='Account Email' className='duration-300 dark:bg-gray-900 border-b-2 border-solid border-white dark:border-black dark:focus:border-white focus:border-black outline-none text-red-500 p-1 w-full max-w-[40ch]'/>
